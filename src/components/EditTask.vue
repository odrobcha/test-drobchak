<template>
    <div class="edit-item">
        ...
        <div class="edit-item-buttons">
            ...
            <button @click="saveChanges(newTitle, newDescription)">Save Changes</button>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            saveChanges(){
                ...
                this.$store.commit('saveChanges',  {id: this.singleItemInfo.id, newTitle: this.newTitle, newDescription: this.newDescription});
